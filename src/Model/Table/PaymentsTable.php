 ...
 * @property \App\Model\Table\PaymentLogTable|\Cake\ORM\Association\HasMany $PaymentLog
 *
...
class PaymentsTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ...
            ->requirePresence('last_payment_date', 'create')
            ->notEmpty('last_payment_date');

        $validator
            ->allowEmpty('last_paid_amount');
