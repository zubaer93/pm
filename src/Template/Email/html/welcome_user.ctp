<table width="660" border="0" align="center" cellpadding="0" cellspacing="0" style="font-family:Arial,Helvetica,sans-serif">
    ...
    <tr>
        <td colspan="3">
            <p style="color: #4e2e4f; padding: 0 35px 0px 35px;">
                Hello <?= $user_details; ?>, <br /> <br />
                Welcome to StockGitter! You are now connected to the international market with the power to make your own financial decisions. Here are some quick features you will find useful as you get on your way to becoming an investor:
            </p>
        </td>
    </tr>
</table>
    ...
    <tr>
        <td style="width: 220px;">
            ...
            <ul style="padding: 0px; width: 90%;">
                ...
                <li>
                    View <b>Buy/Sell ratings</b> from brokers
                </li>
                <li>
                    Get <b>news & analysis</b> from independent contributors.
                </li>
                <li>
                    Get company <b>financial statements and filings.</b>
                </li>
            </ul>
        </td>
        ...
        <td style="width: 220px;">
            ...
            <ul style="padding: 0px; width: 90%; margin-left: 10px;">
                ...
                <li>
                    Buy/Sell USD/JMD Stocks
                </li>
                <li>
                    View <b>Options</b> trading on USD stocks.
                </li>
                <li>
                    View forex and Crypto Currencies
                </li>
                <li>
                    View realtime profit & loss
                </li>
            </ul>
        </td>
        ...
        <td style="width: 220px;">
            ...
            <ul style="padding: 0px; width: 80%; margin-left: 20px;">
                ...
                <li>
                    Share stocks you are interested in and see what others are trading.
                </li>
                <li>
                    Use @stockgitterhelp to ask any questions.
                </li>
            </ul>
        </td>
    </tr>
...
<table width="660" border="0" align="center" cellpadding="0" cellspacing="0" style="font-family:Arial,Helvetica,sans-serif; margin-top: 5px; font-family: Helvetica">
    <tr style="background-color: #efefef">
        <td>
            <p style="text-align: center; font-style: italic; color: #76797e">
                Copyright © 2018 StockGitter.com All rights reserved.
            </p>
        </td>
    </tr>
    <tr style="background-color: #efefef">
    ...
    <tr style="background-color: #efefef">
        <td>
            <p style="text-align: center; color: #273231; margin-bottom: -10px; font-size: 12px; ">
                Disclaimer: <br />
                This website is provided "as is" and "as available" without any representation or warranties, express or <br />
                implied. STOCKGITTER makes no representation or warranties in relation to this website or the <br />
                information and materials provided on this website. StockGitter is in no way liable for you personal <br />
                trading use of the information provided and accepts no responsibility for gains or losses incurred.
            </p>
        </td>
    </tr>
</table>