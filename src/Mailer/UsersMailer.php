...
class UsersMailer extends Mailer
{
     ...
     * @return void
     */
    public function sendNotification($notification, $senderUsername, $emailTo)
    {
        $url = $notification->url;
        $message = $notification->title;
        $this
                ->to($emailTo)
                ->setSubject($senderUsername . ' tagged you')
                ->setViewVars(compact('message', 'url', 'senderUsername'))
                ->setTemplate('send_notification');
    }
    ...
    protected function socialAccountValidation(EntityInterface $user, EntityInterface $socialAccount)
    {
        ...
        $this
                ...
                ->setTemplate('social_account_validation');
    }
