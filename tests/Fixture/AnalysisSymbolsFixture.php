...
/**
 * AnalysisSymbolsFixture
 *
 */
class AnalysisSymbolsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'analysis_symbols_ibfk_1' => ['type' => 'foreign', 'columns' => ['analysis_id'], 'references' => ['analysis', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
