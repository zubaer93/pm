                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 mb-10">
                        <?= $this->Form->textarea('text', [
                            ...
                            'placeholder' => ((isset($analysis)) ? $analysis['text'] : 'My notes/Analysis'),
                            'value' => (isset($analysis)) ? $analysis['text'] : ''
                        ]); ?>
                    </div>
                </div>
            </div>
            <div class="col-lg-12 col-md-12 col-sm-12">
                <?php $target = '#termsModal'; ?>
                <?php if ($accountType == 'FREE'): ?>
                    <?php $target = '.bs-subscription-modal-full'; ?>
                <?php endif; ?>
                                    ...
                                    <div class="col-md-12">
                                        <label class="select">
                                            ...
                                            <?= $this->Form->control('name', [
                                                'required' => true,
                                                'label' => false,
                                                'placeholder' => ((isset($analysis)) ? $analysis['name'] : 'Name'),
                                                'value' => ((isset($analysis)) ? $analysis['name'] : ''),
                                                'class' => 'form-control'
                                            ]); ?>
                                        </label>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <label class="select">
                                            ...
                                            <?= $this->Form->select('type', \App\Model\Service\Core::$investmentPreferences, [
                                                'default' => (isset($analysis) ? $analysis['type'] : null),
                                    ...
                                    <div class="col-md-6">
                                        <label class="select">
                                            ...
                                            <?= $this->Form->control('symbol', [
                                                ...
                                                'label' => false,
                                                'class' => 'form-control',
                                                'placeholder' => $analysis_symbols,
                                                'value' => $analysis_symbols
                                            ]); ?>
                                            <b class="tooltip tooltip-bottom-right"><?= __('Currency Pair') ?></b>
                                        </label>
                                    </div>
