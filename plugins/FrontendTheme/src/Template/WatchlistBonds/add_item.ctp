<?= $this->Form->create($watchlistItem, ['class' => 'js-add-watchlist-form', 'data-url-group' => $this->Url->build(['controller' => 'WatchlistBonds', 'action' => 'add'])]);?>
    <div class="modal-body">
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 mb-10">
                <?= $this->Form->control('watchlist_bond_id', ['options' => $watchlistBonds, 'class' => 'form-control js-watchlist-select', 'label' => 'Choice your watchlist']); ?>
            </div>
