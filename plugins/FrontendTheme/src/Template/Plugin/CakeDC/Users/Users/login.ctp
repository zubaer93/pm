    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6">
                ...
                <fieldset class="m-0">
                    ...
                    <div class="clearfix note mb-30">
                        ...
                        if (Configure::read('Users.Email.required')) {
                            echo $this->Html->link(__d('CakeDC/Users', 'Forgot Password?'), ['action' => 'requestResetPassword'], ['class' => 'float-right']);
                        }
                        ?>
                    </div>
                ...
                <footer>
                    <?= $this->Form->button(__d('CakeDC/Users', '<i class="fa fa-check"></i>' . __('OK, LOG IN')), ['class' => 'btn btn-primary rad-0 float-right']); ?>
                </footer>
            ...
            <div class="col-md-6 col-sm-6">
                ...
                <header class="fs-18 mb-20">
                    <?= __('Sign In using your favourite social network') ?>
                </header>
                ...
                <footer>
                    ...
                    if ($registrationActive) {
                        ...
                        echo $this->Html->link(__d('CakeDC/Users', 'Click to register!'), ['action' => 'register']);
                    }
                    ?>
                </footer>
