...
<select class="form-control select2" name="time_zone">
    ...
    <option value="Pacific/Marquesas">(GMT-09:30) Marquesas Islands
    </option>
    ...
    <option value="Chile/EasterIsland">(GMT-06:00) Easter Island
    </option>
    ...
    <option value="Atlantic/Stanley">(GMT-04:00) Faukland Islands
    </option>
    ...
    <option value="America/Miquelon">(GMT-03:00) Miquelon, St. Pierre
    </option>
    ...
    <option value="Europe/Belfast">(GMT) Greenwich Mean Time : Belfast
    </option>
    <option value="Europe/Dublin">(GMT) Greenwich Mean Time : Dublin
    </option>
    <option value="Europe/Lisbon">(GMT) Greenwich Mean Time : Lisbon
    </option>
    <option value="Europe/London">(GMT) Greenwich Mean Time : London
    </option>
    ...
    <option value="Africa/Algiers">(GMT+01:00) West Central Africa
    </option>
    <option value="Africa/Windhoek">(GMT+01:00) Windhoek</option>
    <option value="Asia/Beirut">(GMT+02:00) Beirut</option>
    <option value="Africa/Cairo">(GMT+02:00) Cairo</option>
    <option value="Asia/Gaza">(GMT+02:00) Gaza</option>
    <option value="Africa/Blantyre">(GMT+02:00) Harare, Pretoria
    </option>
    ...
    <option value="Asia/Kolkata">(GMT+05:30) Chennai, Kolkata, Mumbai,
        New Delhi
    </option>
    ...
    <option value="Australia/Lord_Howe">(GMT+10:30) Lord Howe Island
    </option>
    <option value="Etc/GMT-11">(GMT+11:00) Solomon Is., New Caledonia
    </option>
