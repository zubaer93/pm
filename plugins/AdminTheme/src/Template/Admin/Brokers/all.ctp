        ...
        <div id="panel-2" class="panel panel-default">
            <div class="panel-heading">
                <span class="title elipsis">
                    <strong><?= __('Broker List'); ?></strong> <!-- panel title -->
                </span>

                <!-- right options -->
                <ul class="options pull-right list-inline">
                    <li><?= $this->Html->link(__('Add Broker'), ['_name' => 'add_broker'], ['class' => 'btn btn-3d btn-xs btn-green opt']); ?></li>
            ...
            <div class="panel-body">
                ...
                <div class="table-responsive12 table-responsive">
                    <table id="brokers-grid"  class="table table-striped">
                        <thead>
                            <tr>
                                <th><?= __('ID'); ?></th>
                                <th><?= __('Name'); ?></th>
                                <th><?= __('Fee'); ?></th>
                                <th><?= __('Exchange Fee'); ?></th>
                                <th><?= __('Trade Fee'); ?></th>
                                <th><?= __('Market'); ?></th>
                                <th><?= __('Fees'); ?></th>
                                <th><?= __('Enable'); ?></th>
        ...
        loadScript(plugin_path + "datatables/dataTables.bootstrap.js", function () {
            ...
            if (jQuery().dataTable) {
                var dataTable = $('#brokers-grid').DataTable({
                    ...
                    "serverSide": true,
                    "ajax": {
                        url: '<?= $this->Url->build(['_name' => 'data_table_brokers']); ?>',
                        type: "get",
