<section id="middle">
    <header id="page-header">
        <h1><?= __('All Stocks Details'); ?></h1>
        <ol class="breadcrumb">
            <li><?= $this->Html->link(__('Stocks Details'), '#'); ?></li>
            <li class="active"><?= __('All Stocks Details'); ?></li>
        </ol>
    </header>
        ...
        <div id="panel-1" class="panel panel-default">
            <div class="panel-heading">
                <span class="title elipsis">
                    <strong><?= __('All Stocks Details'); ?></strong> <!-- panel title -->
                </span>

                <!-- right options -->
                <ul class="options pull-right list-inline">
                    <li><?= $this->Html->link(__('Add Company Stock Details'), ['_name' => 'add_stock_details'], ['class' => 'btn btn-3d btn-xs btn-green opt']); ?></li>
                ...
                <div class="table-responsive12 table-responsive">
                    <table id="stock-grid"  class="table table-striped">
                        <thead>
                            <tr>
                                <th><?= __('Company'); ?></th>
                                <th><?= __('High price 52 week'); ?></th>
                                <th><?= __('Low price 52 week'); ?></th>
                                <th><?= __('Days high rice'); ?></th>
                                <th><?= __('Days low rice'); ?></th>
                                <th><?= __('Last traded price'); ?></th>
                                <th><?= __('Bid'); ?></th>
                                <th><?= __('Ask'); ?></th>
                                <th><?= __('Trade Value'); ?></th>
                                <th><?= __('Market cap'); ?></th>
        ...
        loadScript(plugin_path + "datatables/dataTables.bootstrap.js", function () {
            ...
            if (jQuery().dataTable) {
                var dataTable = $('#stock-grid').DataTable({
                    ...
                    "serverSide": true,
                    "ajax": {
                        url: '<?= $this->Url->build(['_name' => 'data_table_stock_details']); ?>',
                        type: "post",
