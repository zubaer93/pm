        ...
        <div class="panel-body">
            <div class="card card-default">
                <div class="card-block">
                    <?= $this->Form->create('', ['enctype' => 'multipart/form-data', 'name' => 'foo']); ?>
                    <fieldset>
                        <div class="row">
                            <div class="col-md-12 col-sm-12">
                                <label><?= __('Title*'); ?></label>
                                <?= $this->Form->control('title', ['required' => true, 'value' => $financialStatement['title'], 'type' => 'text', 'class' => 'form-control', 'label' => false, 'placeholder' => 'Source Name']); ?>
                            </div>
                            <div class="col-md-12 col-sm-12">
                                <label><?= __('Description *'); ?></label>
                                <?= $this->Form->control('description', ['value' => $financialStatement['description'], 'required' => true, 'type' => 'text', 'class' => 'form-control', 'label' => false, 'placeholder' => 'Source Name']); ?>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12 col-sm-12">
                                ...
                                <i class=""></i>
                                <?= $this->Form->select('company_id', $all_companies, ['default' => $financialStatement['company_id'], 'id' => 'dates-field2', 'class' => 'form-control select2']); ?>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <input type="hidden" name="edit_file_name_admin">
                                <?php foreach ($financialStatement['financial_statement_files'] as $file): ?>
                                    <div class="input_partial_main">
                                        <a type="button" class="btn btn-3d btn-danger btn-xs delete_main_partial"><i class="fa fa-times"></i></a>

                                        <input type="text" name="file_name_admin[]" class="form-control"  value="<?= $file['file_path']; ?>" placeholder="<?= $file['file_path']; ?>" readonly="true">
                                    </div>                               
                                <?php endforeach; ?>
